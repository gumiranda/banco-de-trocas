    ...
    <Container maxW={"7xl"} p="12">
      ...
      <Wrap spacing="30px" marginTop="5">
        <WrapItem width={{ base: "100%", sm: "45%", md: "45%", lg: "30%" }}>
          <Box w="100%">
            <Box borderRadius="lg" overflow="hidden">
              <Box textDecoration="none" _hover={{ textDecoration: "none" }}>
                <Image
                  transform="scale(1.0)"
                  src={
                    "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/10/2f/c3/ea.jpg"
                  }
                  alt="some text"
                  objectFit="contain"
                  width="100%"
            ...
            <BlogTags tags={["Finanças", "Imóveis", "Oportunidade"]} marginTop={3} />
            <Heading fontSize="xl" marginTop="2">
              <Text textDecoration="none" _hover={{ textDecoration: "none" }}>
                Uma História de Venda no Guarujá: Onde Sempre Há um Comprador
              </Text>
            </Heading>
            <Text as="p" fontSize="md" marginTop="2">
              {`Hoje, 28 de agosto, segunda-feira fria e chuvosa, gostaria de compartilhar
            ...
            <BlogAuthor name="Gilson Aguiar" date={new Date(2023, 7, 28)} />
          </Box>
        </WrapItem>
        <WrapItem width={{ base: "100%", sm: "45%", md: "45%", lg: "30%" }}>
          <Box w="100%">
            <Box borderRadius="lg" overflow="hidden">
              <Box textDecoration="none" _hover={{ textDecoration: "none" }}>
                <Image
                  transform="scale(1.0)"
                  src={
                    "https://media-cdn.tripadvisor.com/media/vr-splice-j/0f/e8/20/11.jpg"
                  }
                  alt="some text"
                  objectFit="contain"
                  width="100%"
            ...
            <Text as="p" fontSize="md" marginTop="2">
              {`Boa tarde a todos, e um agradecimento especial a cada um de vocês que entraram nesse site. Recentemente, escrevi sobre o "Caminho das Pedras",
            ...
            <BlogAuthor name="Gilson Aguiar" date={new Date(2023, 8, 7)} />
          </Box>
        </WrapItem>
        <WrapItem width={{ base: "100%", sm: "45%", md: "45%", lg: "30%" }}>
          <Box w="100%">
            <Box borderRadius="lg" overflow="hidden">
              <Box textDecoration="none" _hover={{ textDecoration: "none" }}>
                <Image
                  transform="scale(1.0)"
                  src={
                    "https://media-cdn.tripadvisor.com/media/vr-splice-j/03/67/09/63.jpg"
                  }
                  alt="some text"
                  objectFit="contain"
                  width="100%"
            ...
            <Heading fontSize="xl" marginTop="2">
              <Text textDecoration="none" _hover={{ textDecoration: "none" }}>
                O Caminho das Pedras no Mercado Imobiliário
              </Text>
            </Heading>
            <Text as="p" fontSize="md" marginTop="2">
              {`Meu nome é Gilson Gonçalves de Aguiar, e sou um corretor de imóveis
      ...
      <VStack paddingTop="40px" spacing="2" alignItems="flex-start">
        ...
        <Text as="p" fontSize="lg">
          ...
          por R$40.000,00. Se não tivesse tomado essa decisão, quem sabe onde estaria hoje?
          Eu usava o carro apenas para atividades cotidianas como ir à padaria, ao shopping
          e viagens esporádicas. Hoje, optei por táxi, faço pequenas caminhadas e economizo
          significativamente. Com o dinheiro da venda do carro, pude quitar dívidas e
          adquirir um apartamento em construção da Tarjab, o Hit Morumbi. Estou pagando
          R$1.000,00 por mês, e quando as chaves forem entregues em setembro/2025,
          precisarei pagar apenas R$200.000,00 para ter meu próprio lar, com um apartamento
          de 40 m², bem localizado e com estacionamento. Acredito que tenha sido um
          excelente negócio, embora enfrentarei o desafio de conseguir os R$200.000,00 em
          dois anos. Tenho fé que Deus proverá.
        </Text>
      </VStack>
    </Container>
  );
